...
function createScene()
{
    ...
    createSphere(glObjects);
    createOctahedron(glObjects);
    createCuboid(glObjects, cuboidRotation);
    createCuboid(glObjects, cuboid2Rotation);
    createNail(glObjects, nail1Position, nailRotation);
    createNail(glObjects, nail2Position, nailRotation);
    createNail(glObjects, nail3Position, nail2Rotation);
    createNail(glObjects, nail4Position, nail2Rotation);
    createNail(glObjects, nail5Position, nail3Rotation);
    createNail(glObjects, nail6Position, nail3Rotation);
...
function createSphere(glObjects)
{
...
function createOctahedron(glObjects)
{
...
function createCuboid(glObjects, rotation)
{
...
function createNail(glObjects, position, rotation)
{
